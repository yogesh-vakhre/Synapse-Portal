...
<!--Page title -->
@section('title', 'Verify 2FA Authentication')
                                    ...
                                    <tr>
                                        <td class="v-container-padding-padding"
                                            ...
                                            <div
                                                ...
                                                <p style="line-height: 140%;">Your OTP is : {{ $details['code'] }}</p>
                                            </div>
                                    ...
                                    <tr>
                                        <td class="v-container-padding-padding"
                                            ...
                                            <div align="center">
                                                ...
                                                <a href="{{ route('2fa.index') }}" target="_blank" class="v-button"
                                                    ...
                                                    <span class="v-padding"
                                                        style="display:block;padding:10px 20px;line-height:120%;"><span
                                                            style="line-height: 16.8px;">Confirm Your 2FA OTP </span></span>
                                                </a>
