                     ...
                     <div class="col-12">
                             ...
                             <div class="header-body">
                                 <div class="row align-items-center">
                                     ...
                                     <div class="col-auto">
                                         ...
                                         <!-- Buttons -->
                                         <a href="{{ route('websites.create') }}" class="btn btn-primary ms-2">
                                             Add website
                                         </a>
                                 ...
                                 <div class="row align-items-center">
                                     <div class="col">
                                         ...
                                         <ul class="nav nav-tabs nav-overflow header-tabs">
                                             <li class="nav-item">
                                                 <a href="{{ route('citadels.index') }}" class="nav-link text-nowrap">
                                                     Citadels <span
                                             ...
                                             <li class="nav-item">
                                                 <a href="{{ route('web-applications.index') }}"
                                             ...
                                             <li class="nav-item">
                                                 <a href="{{ route('mobile-apps.index') }}" class="nav-link text-nowrap">
                                                     Mobile Apps <span
                                                         class="badge rounded-pill text-bg-secondary-subtle">22</span>
                                                 </a>
                                             </li>
                                             <li class="nav-item">
                                                 <a href="{{ route('digital-marketings.index') }}" class="nav-link text-nowrap">
                                                     Digital Marketing <span
                                                         class="badge rounded-pill text-bg-secondary-subtle">22</span>
                                                 </a>
                                             </li>
                                             <li class="nav-item">
                                                 <a href="{{ route('engages.index') }}" class="nav-link text-nowrap">
                                                     Engage<span
                                                         class="badge rounded-pill text-bg-secondary-subtle">22</span>
                                                 </a>
                                             </li>
                         ...
                         <div class="tab-content">
                             <div class="tab-pane fade show active" id="contactsListPane" role="tabpanel"
                                 ...
                                 <!-- Card -->
                                 <div class="card"
                                     data-list='{"valueNames": ["item-website-members", "item-doWeHost", "item-private-webiste"], "page": 10, "pagination": {"paginationClass": "list-pagination"}}'
                                     id="contactsList">
                                                 ...
                                                 <tr>
                                                     ...
                                                     <th>
                                                         <a class="list-sort text-body-secondary"
                                                             data-sort="item-website-name" href="#">Website name</a>
                                                     </th>
                                                     <th>
                                                         <a class="list-sort text-body-secondary"
                                                             data-sort="item-website-members" href="#">Webiste
                                                             members</a>
                                                     </th>
                                                     <th>
                                                         <a class="list-sort text-body-secondary"
                                                             data-sort="item-private-webiste" href="#"> Private
                                                             Webiste</a>
                                                     </th>
                                             ...
                                             <tbody class="list fs-base">
                                                 <tr>
                                                     ...
                                                     <td>
                                                         ...
                                                         <!-- Text -->
                                                         <span class="item-website-name">Synapse</span>

                                                     </td>
                                                     <td>

                                                         <!-- Text -->
                                                         <span class="item-auto-renew">John,Tony,Jack</span>

                                                     </td>
                                                     <td>

                                                         <!-- Text -->
                                                         <span class="item-private-webiste">yes</span>
                                                     ...
                                                     <td class="text-end">
                                                         ...
                                                         <div class="dropdown">
                                                             ...
                                                             <div class="dropdown-menu dropdown-menu-end">
                                                                 <a href="{{ route('websites.destroy', 1) }}"
                                                                     class="dropdown-item">
                                                                     Delete
                                                                 </a>
                                                                 <a href="{{ route('websites.edit', 1) }}"
                                                                     class="dropdown-item">
                                                                     Edit
                                                                 </a>
                                                                 <a href="{{ route('websites.show', 1) }}"
                                                                     class="dropdown-item">
                                                                     Show
                                                                 </a>
                                                             </div>
                             ...
                             <div class="tab-pane fade" id="contactsCardsPane" role="tabpanel"
                                 ...
                                 <!-- Cards -->
                                 <div data-list='{"valueNames": ["private-webiste", "item-auto-renew"], "page": 9, "pagination": {"paginationClass": "list-pagination"}}'
                                     id="contactsCards">
                                             ...
                                             <div class="card">
                                                 <div class="card-body">
                                                     ...
                                                     <div class="text-center mb-5">
                                                         ...
                                                         <!-- Heading -->
                                                         <h2 class="card-title">
                                                             <a class="private-webiste"
                                                                 href="{{ route('websites.show', 1) }}">Dianna
                                                                 Smiley</a>
                                                         </h2>
                                                         ...
                                                         <div class="list-group-item">
                                                             <div class="row">
                                                                 <div class="col">
                                                                     ...
                                                                     <!-- Text -->
                                                                     <small class="item-ext-no">Website name</small>
                                                         ...
                                                         <div class="list-group-item">
                                                             <div class="row">
                                                                 <div class="col">
                                                                     ...
                                                                     <!-- Text -->
                                                                     <small class="item-website-licence">Website
                                                                         members</small>
