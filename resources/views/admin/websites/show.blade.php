                                    ...
                                    <div class="col-auto">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <a href="{{ route('websites.destroy', 1) }}" class="dropdown-item">
                                                    Delete
                                                </a>
                                                <a href="{{ route('websites.edit', 1) }}" class="dropdown-item">
                                                    Edit
                                                </a>
                                                <a href="{{ route('websites.show', 1) }}" class="dropdown-item">
                                                    Show
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="list-group-item">
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <!-- Text -->
                                                <small class="item-website-licence">Website members</small>
