     ...
     <!--Page title -->
     @section('title', 'IT Services - Managed IT')
                             ...
                             <div class="header-body">
                                 <div class="row align-items-center">
                                     ...
                                     <div class="col-auto">
                                         ...
                                         <!-- Buttons -->
                                         <a href="{{ route('managed-its.create') }}" class="btn btn-primary ms-2">
                                             Add Managed IT
                                         </a>
                                                 ...
                                                 <tr>
                                                     ...
                                                     <td>
                                                         ...
                                                         <div class="avatar avatar-xs align-middle me-2">
                                                             ...
                                                             href="{{ route('managed-its.show', 1) }}">Dianna </a>
                                                     ...
                                                     <td class="text-end">
                                                         ...
                                                         <div class="dropdown">
                                                             ...
                                                             <div class="dropdown-menu dropdown-menu-end">
                                                                 <a href="{{ route('managed-its.destroy', 1) }}"
                                                                     class="dropdown-item">
                                                                     Delete
                                                                 </a>
                                                                 <a href="{{ route('managed-its.edit', 1) }}"
                                                                     class="dropdown-item">
                                                                     Edit
                                                                 </a>
                                                                 <a href="{{ route('managed-its.show', 1) }}"
                                                                     class="dropdown-item">
                                                                     Show
                                                                 </a>
                                                             </div>
                                             ...
                                             <div class="card">
                                                 <div class="card-body">
                                                     ...
                                                     <div class="text-center mb-5">
                                                         ...
                                                         <h2 class="card-title">
                                                             <a class="item-name"
                                                                 href="{{ route('managed-its.show', 1) }}">Dianna
                                                                 Smiley</a>
                                                         </h2>
