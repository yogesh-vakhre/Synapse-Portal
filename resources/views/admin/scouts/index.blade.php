                             ...
                             <div class="header-body">
                                 <div class="row align-items-center">
                                     ...
                                     <div class="col-auto">
                                         ...
                                         <!-- Buttons -->
                                         <a href="{{ route('scouts.create') }}" class="btn btn-primary ms-2">
                                             Add scout
                                         </a>
                                 ...
                                 <div class="row align-items-center">
                                     <div class="col">
                                         ...
                                         <ul class="nav nav-tabs nav-overflow header-tabs">
                                             ...
                                             <li class="nav-item">
                                                 <a href="{{ route('active-tracks.index') }}" class="nav-link text-nowrap">
                                                    ActiveTrack <span
                                                 ...
                                                 <tr>
                                                     ...
                                                     <th>
                                                         <a class="list-sort text-body-secondary"
                                                             data-sort="item-ipAddress" href="#">IP Address </a>
                                                     </th>
                                                     <th>
                                                         <a class="list-sort text-body-secondary" data-sort="item-website"
                                                             href="#">Website</a>
                                                     </th>
                                                     <th>
                                                         <a class="list-sort text-body-secondary"
                                                             data-sort="item-how-often-to-run" href="#">How often to
                                                             run</a>
                                                     </th>
                                                     <th>
                                                         <a class="list-sort text-body-secondary"
                                                             data-sort="item-date-to-run" href="#">Date to run
                                                         </a>
                                                     </th>
                                                     <th>
                                                         <a class="list-sort text-body-secondary"
                                                             data-sort="item-email-to-send-report" href="#">Email to
                                                             send report </a>
                                                     </th>
                                                 </tr>
                                             </thead>
                                                     ...
                                                     <td>
                                                         ...
                                                         <div class="avatar avatar-xs align-middle me-2">
                                                             <img class="avatar-img rounded-circle"
                                                                 ...
                                                                 alt="...">
                                                         </div> <a class="item-ipAddress text-reset"
                                                             href="{{ route('scouts.show', 1) }}">xxxx.xxx.xxx.xx </a>

                                                     </td>
                                                     <td>

                                                         <!-- Text -->
                                                         <span class="item-website">http://example.com</span>

                                                     </td>
                                                     <td>

                                                         <!-- Text -->
                                                         <span class="item-how-often-to-run ">ACXXXXX0000</span>

                                                     </td>
                                                     <td>

                                                         <!-- Text -->
                                                         <span class="item-date-to-run">22 June 2023</span>

                                                     </td>
                                                     <td>

                                                         <!-- Text -->
                                                         <span class="item-email-to-send-report">Yes</span>
                                                     ...
                                                     <td class="text-end">
                                                         ...
                                                         <div class="dropdown">
                                                             ...
                                                             <div class="dropdown-menu dropdown-menu-end">
                                                                 <a href="{{ route('scouts.destroy', 1) }}"
                                                                     class="dropdown-item">
                                                                     Delete
                                                                 </a>
                                                                 <a href="{{ route('scouts.edit', 1) }}"
                                                                     class="dropdown-item">
                                                                     Edit
                                                                 </a>
                                                                 <a href="{{ route('scouts.show', 1) }}"
                                                                     class="dropdown-item">
                                                                     Show
                                                                 </a>
                                                             </div>
                                                         ...
                                                         <div class="list-group-item">
                                                             <div class="row">
                                                                 <div class="col">
                                                                     ...
                                                                     <!-- Text -->
                                                                     <small class="item-scout-licence">scout
                                                                         Licence</small>
