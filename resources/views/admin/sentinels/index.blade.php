                             ...
                             <div class="header-body">
                                 <div class="row align-items-center">
                                     ...
                                     <div class="col-auto">
                                         ...
                                         <!-- Buttons -->
                                         <a href="{{ route('sentinels.create') }}" class="btn btn-primary ms-2">
                                             Add sentinel
                                         </a>
                                                 ...
                                                 <tr>
                                                     ...
                                                     <th>
                                                         <a class="list-sort text-body-secondary"
                                                             data-sort="item-company-to-test" href="#">Company to
                                                             test
                                                         </a>
                                                     </th>
                                                     <th>
                                                         <a class="list-sort text-body-secondary"
                                                             data-sort="item-month-testing " href="#">Month
                                                             testing</a>
                                                     </th>
                                             ...
                                             <tbody class="list fs-base">
                                                 <tr>
                                                     ...
                                                     <td>
                                                         ...
                                                         <!-- Text -->
                                                         <span class="item-company-to-test">Test</span>
                                                     ...
                                                     <td class="text-end">
                                                         ...
                                                         <div class="dropdown">
                                                             ...
                                                             <div class="dropdown-menu dropdown-menu-end">
                                                                 <a href="{{ route('sentinels.destroy', 1) }}"
                                                                     class="dropdown-item">
                                                                     Delete
                                                                 </a>
                                                                 <a href="{{ route('sentinels.edit', 1) }}"
                                                                     class="dropdown-item">
                                                                     Edit
                                                                 </a>
                                                                 <a href="{{ route('sentinels.show', 1) }}"
                                                                     class="dropdown-item">
                                                                     Show
                                                                 </a>
                                                             </div>
                                                         ...
                                                         <div class="list-group-item">
                                                             <div class="row">
                                                                 <div class="col">
                                                                     ...
                                                                     <!-- Text -->
                                                                     <small class="item-company-to-test ">Company to test
                                                                     </small>
