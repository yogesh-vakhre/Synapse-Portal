     ...
     <!--Page title -->
     @section('title', 'Internet backups')
                     ...
                     <div class="col-12">
                             ...
                             <div class="header-body">
                                 <div class="row align-items-center">
                                     ...
                                     <div class="col-auto">
                                         ...
                                         <!-- Buttons -->
                                         <a href="{{ route('internet-backups.create') }}" class="btn btn-primary ms-2">
                                             Add internet backup
                                         </a>
                                 ...
                                 <div class="row align-items-center">
                                     <div class="col">
                                         ...
                                         <ul class="nav nav-tabs nav-overflow header-tabs">
                                             <li class="nav-item">
                                                 <a href="{{ route('voices.index') }}" class="nav-link text-nowrap ">
                                                    Voice <span
                                             ...
                                             <li class="nav-item active">
                                                 <a href="" class="nav-link text-nowrap">
                                                     Internet backups <span
                                                         class="badge rounded-pill text-bg-secondary-subtle">231</span>
                                                 </a>
                                             </li>
                                             <li class="nav-item">
                                                <li class="nav-item">
                                                    <a href="{{ route('slipstreams.index') }}" class="nav-link text-nowrap">
                                                       Slipstream <span
                         ...
                         <div class="tab-content">
                             <div class="tab-pane fade show active" id="contactsListPane" role="tabpanel"
                                 ...
                                 <!-- Card -->
                                 <div class="card"
                                     data-list='{"valueNames": ["item-line-type", "item-provider", "item-package", "item-contract-length","item-renewal-date"], "page": 10, "pagination": {"paginationClass": "list-pagination"}}'
                                     id="contactsList">
                                         ...
                                         <table class="table table-sm table-hover table-nowrap card-table">
                                             <thead>
                                                 <tr>
                                                     ...
                                                     <th>
                                                         <a class="list-sort text-body-secondary" data-sort="item-line-type"
                                                             href="#">Line Type</a>
                                                     </th>
                                                     <th>
                                                         <a class="list-sort text-body-secondary" data-sort="item-provider"
                                                             href="#"> Provider</a>
                                                     </th>
                                                     <th>
                                                         <a class="list-sort text-body-secondary"
                                                             data-sort="item-package" href="#">Package</a>
                                                     </th>
                                                     <th>
                                                         <a class="list-sort text-body-secondary"
                                                             data-sort="item-contract-length" href="#">Contract length
                                                         </a>
                                                     </th>
                                                     <th>
                                                         <a class="list-sort text-body-secondary"
                                                             data-sort="item-renewal-date" href="#"> Renewal date </a>
                                                     </th>
                                                 </tr>
                                             </thead>
                                             <tbody class="list fs-base">
                                                 <tr>
                                                     ...
                                                     <td>
                                                         ...
                                                         <div class="avatar avatar-xs align-middle me-2">
                                                             <img class="avatar-img rounded-circle"
                                                                 ...
                                                                 alt="...">
                                                         </div> <a class="item-line-type text-reset"
                                                             href="{{ route('internet-backups.show', 1) }}">FTTP </a>

                                                     </td>
                                                     <td>

                                                         <!-- Text -->
                                                         <span class="item-provider">Vodaphone</span>

                                                     </td>
                                                     <td>

                                                         <!-- Text -->
                                                         <span class="item-item-package">Sms: 100 Unlimited callll</span>

                                                     </td>
                                                     <td>

                                                         <!-- Text -->
                                                         <span class="item-contract-length ">1year</span>
                                                     ...
                                                     <td>
                                                         ...
                                                         <!-- Text -->
                                                         <span class="item-renewal-date">10 Jan 2024</span>
                                                     ...
                                                     <td class="text-end">
                                                         ...
                                                         <div class="dropdown">
                                                             ...
                                                             <div class="dropdown-menu dropdown-menu-end">
                                                                 <a href="{{ route('internet-backups.destroy', 1) }}"
                                                                     class="dropdown-item">
                                                                     Delete
                                                                 </a>
                                                                 <a href="{{ route('internet-backups.edit', 1) }}"
                                                                     class="dropdown-item">
                                                                     Edit
                                                                 </a>
                                                                 <a href="{{ route('internet-backups.show', 1) }}"
                                                                     class="dropdown-item">
                                                                     Show
                                                                 </a>
                                                             </div>
                             ...
                             <div class="tab-pane fade" id="contactsCardsPane" role="tabpanel"
                                 ...
                                 <!-- Cards -->
                                 <div data-list='{"valueNames": ["item-line-type", "item-provider", "item-package"], "page": 9, "pagination": {"paginationClass": "list-pagination"}}'
                                     id="contactsCards">
                                                             ...
                                                             <div class="list-group-item">
                                                                 <div class="row">
                                                                     ...
                                                                     <div class="col-auto">
                                                                         ...
                                                                         <!-- Select -->
                                                                         <select class="form-select form-select-sm" name="item-line-type"
                                                                             data-choices='{"searchEnabled": false}'>
                                             ...
                                             <div class="card">
                                                 <div class="card-body">
                                                     ...
                                                     <div class="text-center mb-5">
                                                         ...
                                                         <!-- Heading -->
                                                         <h2 class="card-title">
                                                             <a class="item-package"
                                                                 href="{{ route('internet-backups.show', 1) }}">Dianna
                                                                 Skyline Pro</a>
                                                         </h2>
                                                         ...
                                                         <div class="list-group-item">
                                                             <div class="row">
                                                                 <div class="col">
                                                                     ...
                                                                     <!-- Text -->
                                                                     <small class="item-voice-licence">Provider</small>
