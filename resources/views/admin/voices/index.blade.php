                             ...
                             <div class="header-body">
                                 <div class="row align-items-center">
                                     ...
                                     <div class="col-auto">
                                         ...
                                         <!-- Buttons -->
                                         <a href="{{ route('voices.create') }}" class="btn btn-primary ms-2">
                                             Add voice
                                         </a>
                                 ...
                                 <div class="row align-items-center">
                                     <div class="col">
                                         ...
                                         <ul class="nav nav-tabs nav-overflow header-tabs">
                                             ...
                                             {{-- <li class="nav-item">
                                                 <a href="{{ route('internet-backups.index') }}" class="nav-link text-nowrap">
                                         ...
                                         <table class="table table-sm table-hover table-nowrap card-table">
                                             <thead>
                                                 <tr>
                                                     ...
                                                     <th>
                                                         <a class="list-sort text-body-secondary" data-sort="item-ext-no"
                                                             href="#"> Ext No</a>
                                                     </th>
                                                     <th>
                                                         <a class="list-sort text-body-secondary"
                                                             data-sort="item-voice-license" href="#">Voice
                                                             license</a>
                                                     </th>
                                                     <th>
                                                         <a class="list-sort text-body-secondary"
                                                             data-sort="item-handset-model" href="#">Handset model
                                                         </a>
                                                     </th>
                                                     <th>
                                                         <a class="list-sort text-body-secondary"
                                                             data-sort="item-it-asset-no" href="#"> IT Asset No </a>
                                                     </th>
                                                 </tr>
                                             </thead>
                                                 ...
                                                 <tr>
                                                     ...
                                                     <td>
                                                         ...
                                                         <div class="avatar avatar-xs align-middle me-2">
                                                             ...
                                                             href="{{ route('voices.show', 1) }}">Dianna Smiley </a>

                                                     </td>
                                                     <td>

                                                         <!-- Text -->
                                                         <span class="item-ext-no">ASDW44545</span>

                                                     </td>
                                                     <td>

                                                         <!-- Text -->
                                                         <span class="item-voice-license ">ACXXXXX0000</span>

                                                     </td>
                                                     <td>

                                                         <!-- Text -->
                                                         <span class="item-item-handset-model">modal</span>

                                                     </td>
                                                     <td>

                                                         <!-- Text -->
                                                         <span class="item-item-it-asset-no">1001</span>
                                                         ...
                                                         <div class="list-group-item">
                                                             <div class="row">
                                                                 <div class="col">
                                                                     ...
                                                                     <!-- Text -->
                                                                     <small class="item-voice-licence">Voice
                                                                         Licence</small>
