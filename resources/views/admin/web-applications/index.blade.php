                     ...
                     <div class="col-12">
                             ...
                             <div class="header-body">
                                 <div class="row align-items-center">
                                     ...
                                     <div class="col-auto">
                                         ...
                                         <!-- Buttons -->
                                         <a href="{{ route('web-applications.create') }}" class="btn btn-primary ms-2">
                                 ...
                                 <div class="row align-items-center">
                                     <div class="col">
                                         ...
                                         <ul class="nav nav-tabs nav-overflow header-tabs">
                                             ...
                                             <li class="nav-item">
                                                 <a href="{{ route('websites.index') }}" class="nav-link text-nowrap">
                                                     Websites <span
                                             ...
                                             <li class="nav-item">
                                                 <a href="{{ route('digital-marketings.index') }}"
                         ...
                         <div class="tab-content">
                             <div class="tab-pane fade show active" id="contactsListPane" role="tabpanel"
                                 ...
                                 <!-- Card -->
                                 <div class="card"
                                     data-list='{"valueNames": ["item-members", "item-name", "item-private"], "page": 10, "pagination": {"paginationClass": "list-pagination"}}'
                                     id="contactsList">
                                             ...
                                             <tbody class="list fs-base">
                                                 <tr>
                                                     ...
                                                     <td>
                                                         ...
                                                         <!-- Text -->
                                                         <span class="item--name">Synapse</span>
                                                     ...
                                                     <td class="text-end">
                                                         ...
                                                         <div class="dropdown">
                                                             ...
                                                             <div class="dropdown-menu dropdown-menu-end">
                                                                 <a href="{{ route('web-applications.destroy', 1) }}"
                                                                     class="dropdown-item">
                                                                     Delete
                                                                 </a>
                                                                 <a href="{{ route('web-applications.edit', 1) }}"
                                                                     class="dropdown-item">
                                                                     Edit
                                                                 </a>
                                                                 <a href="{{ route('web-applications.show', 1) }}"
                                                                     class="dropdown-item">
                                                                     Show
                                                                 </a>
                                                             </div>
                                                     ...
                                                     <div class="text-center mb-5">
                                                         ...
                                                         <h2 class="card-title">
                                                             <a class="private-webiste"
                                                                 href="{{ route('web-applications.show', 1) }}">Dianna
                                                                 Smiley</a>
                                                         </h2>
