                     ...
                     <div class="col-12">
                             ...
                             <div class="header-body">
                                 <div class="row align-items-center">
                                     ...
                                     <div class="col-auto">
                                         ...
                                         <!-- Buttons -->
                                         <a href="{{ route('citadels.create') }}" class="btn btn-primary ms-2">
                                             Add citadel
                                         </a>
                         ...
                         <div class="tab-content">
                                                 ...
                                                 <tr>
                                                     ...
                                                     <th>
                                                         <a class="list-sort text-body-secondary"
                                                             data-sort="item-do-we-host" href="#">Do we host</a>
                                                     </th>
                                                     <th>
                                                         <a class="list-sort text-body-secondary"
                                                             data-sort="item-autoRenew" href="#"> Auto renew</a>
                                                     </th>
                                                     <th>
                                                         <a class="list-sort text-body-secondary"
                                                             data-sort="item-renewalDate" href="#"> Renewal date</a>
                                                     </th>
                                             ...
                                             <tbody class="list fs-base">
                                                 <tr>
                                                     ...
                                                     <td>
                                                         ...
                                                         <!-- Text -->
                                                         <span class="item-do-we-host">Yes</span>

                                                     </td>
                                                     <td>

                                                         <!-- Text -->
                                                         <span class="item-auto-renew">Yes</span>

                                                     </td>
                                                     <td>

                                                         <!-- Text -->
                                                         <span class="item-renewalDate ">10 Jan 2023</span>
                                                     ...
                                                     <td class="text-end">
                                                         ...
                                                         <div class="dropdown">
                                                             ...
                                                             <div class="dropdown-menu dropdown-menu-end">
                                                                 <a href="{{ route('citadels.destroy', 1) }}"
                                                                     class="dropdown-item">
                                                                     Delete
                                                                 </a>
                                                                 <a href="{{ route('citadels.edit', 1) }}"
                                                                     class="dropdown-item">
                                                                     Edit
                                                                 </a>
                                                                 <a href="{{ route('citadels.show', 1) }}"
                                                                     class="dropdown-item">
                                                                     Show
                                                                 </a>
                                                             </div>
                             ...
                             <div class="tab-pane fade" id="contactsCardsPane" role="tabpanel"
                                 ...
                                 <!-- Cards -->
                                 <div data-list='{"valueNames": ["renewalDate", "item-auto-renew"], "page": 9, "pagination": {"paginationClass": "list-pagination"}}'
                                     id="contactsCards">
                                                             ...
                                                             <div class="list-group-item">
                                                                 <div class="row">
                                                                     ...
                                                                     <div class="col-auto">
                                                                         ...
                                                                         <!-- Select -->
                                                                         <input class="form-control" name="renewalDate"
                                                                             data-choices='{"searchEnabled": false}'>
                                             ...
                                             <div class="card">
                                                 <div class="card-body">
                                                     ...
                                                     <div class="text-center mb-5">
                                                         ...
                                                         <h2 class="card-title">
                                                             <a class="renewalDate"
                                                                 href="{{ route('citadels.show', 1) }}">Dianna
                                                                 Smiley</a>
                                                         </h2>
