                         ...
                         <div class="header">
                             <div class="header-body">
                                 ...
                                 <ul class="nav nav-tabs nav-overflow header-tabs">
                                     <li class="nav-item">
                                         <a href="{{ route('activity_logs.index') }}" class="nav-link text-nowrap">
                                     ...
                                     <div class="card-footer d-flex justify-content-between">
                                         ...
                                         <div id="list-alert-modal"
                                             ...
                                             <div class="row align-items-center">
                                                 ...
                                                 <div class="col-auto me-n3">
                                                     <!-- Button -->
                                                     <button type="button" name="bulk_delete" id="force_bulk_delete"
                                                         data-action={{ route('activity_logs.force_delete_all') }}
                                                         class="btn btn-sm bg-white text-white bg-opacity-20 bg-opacity-15-hover">
                                                         Force Delete
                                                     </button>

                                                     <button type="button" name="bulk_restore" id="restore_bulk_delete"
                                                         data-action={{ route('activity_logs.history.restore_all') }}
                                                         class="btn btn-sm bg-white text-white bg-opacity-20 bg-opacity-15-hover">
                                                         Restore
                                                     </button>
                                                 </div>
     ...
     @push('footer-js-css')
         <!--Datatable -->
         @include('admin.activity_logs.delete-history-datatable')
     @endpush
