                     ...
                     <div class="col-12">
                             ...
                             <div class="header-body">
                                 <div class="row align-items-center">
                                     ...
                                     <div class="col-auto">
                                         ...
                                         <!-- Buttons -->
                                         <a href="{{ route('digital-marketings.create') }}" class="btn btn-primary ms-2">
                         ...
                         <div class="tab-content">
                                             ...
                                             <tbody class="list fs-base">
                                                 <tr>
                                                     ...
                                                     <td>
                                                         ...
                                                         <!-- Text -->
                                                         <span class="item-member">John,Tony,Jack</span>

                                                     </td>
                                                     <td>

                                                         <!-- Text -->
                                                         <span class="item-private">yes</span>
                                                     ...
                                                     <td class="text-end">
                                                         ...
                                                         <div class="dropdown">
                                                             ...
                                                             <div class="dropdown-menu dropdown-menu-end">
                                                                 <a href="{{ route('digital-marketings.destroy', 1) }}"
                                                                     class="dropdown-item">
                                                                     Delete
                                                                 </a>
                                                                 <a href="{{ route('digital-marketings.edit', 1) }}"
                                                                     class="dropdown-item">
                                                                     Edit
                                                                 </a>
                                                                 <a href="{{ route('digital-marketings.show', 1) }}"
                                                                     class="dropdown-item">
                                                                     Show
                                                                 </a>
                                                             </div>
                             ...
                             <div class="tab-pane fade" id="contactsCardsPane" role="tabpanel"
                                 ...
                                 <!-- Cards -->
                                 <div data-list='{"valueNames": ["private", "item-name"], "page": 9, "pagination": {"paginationClass": "list-pagination"}}'
                                     id="contactsCards">
                                                     ...
                                                     <div class="text-center mb-5">
                                                         ...
                                                         <h2 class="card-title">
                                                             <a class="private-webiste"
                                                                 href="{{ route('digital-marketings.show', 1) }}">Dianna
                                                                 Smiley</a>
                                                         </h2>
