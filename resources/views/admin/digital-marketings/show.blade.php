...
<!--Page title -->
@section('title', 'Show digital marketing ')
                            ...
                            <div class="row align-items-center">
                                <div class="col">
                                    ...
                                    <h6 class="header-pretitle">
                                        Show digital marketing
                                    </h6>

                                    <!-- Title -->
                                    <h1 class="header-title">
                                        Show a digital marketing
                                    </h1>
                                    ...
                                    <div class="col-auto">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                ...
                                                <a href="{{ route('digital-marketings.edit', 1) }}" class="dropdown-item">
                                                    Edit
                                                </a>
                                                <a href="{{ route('digital-marketings.show', 1) }}" class="dropdown-item">
                                                    Show
                                                </a>
                                            </div>
                                        </div>
