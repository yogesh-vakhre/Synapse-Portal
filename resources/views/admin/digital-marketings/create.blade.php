...
<!--Page title -->
@section('title', 'New digital marketing')
                            ...
                            <div class="row align-items-center">
                                <div class="col">
                                    ...
                                    <h1 class="header-title">
                                        Create a new digital marketing
                                    </h1>
                    ...
                    <form class="mb-4">
                        ...
                        <div class="form-group">
                            ...
                            <div class="dropzone dropzone-single mb-3"
                                ...
                                <div class="fallback">
                                    <div class="form-group">
                                        <label class="form-label" for="CoverUploads">Choose file</label>
                                        <input class="form-control" type="file" id="CoverUploads">
                                    </div>
                                </div>
                                ...
                                <div class="card bg-light border">
                                    <div class="card-body">
                                        ...
                                        <p class="small text-body-secondary mb-0">
                                            Once a is made private, you cannot revert it to a public .
                                        </p>
