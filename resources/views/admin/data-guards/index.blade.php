     ...
     <!--Page title -->
     @section('title', 'IT Services - Data guard')
                             ...
                             <div class="header-body">
                                 <div class="row align-items-center">
                                     ...
                                     <div class="col-auto">
                                         ...
                                         <!-- Buttons -->
                                         <a href="{{ route('data-guards.create') }}" class="btn btn-primary ms-2">
                                             Add Data guard
                                         </a>
                                                 ...
                                                 <tr>
                                                     ...
                                                     <td>
                                                         ...
                                                         <div class="avatar avatar-xs align-middle me-2">
                                                             ...
                                                             href="{{ route('data-guards.show', 1) }}">Dianna </a>
                                                     ...
                                                     <td class="text-end">
                                                         ...
                                                         <div class="dropdown">
                                                             ...
                                                             <div class="dropdown-menu dropdown-menu-end">
                                                                 <a href="{{ route('data-guards.destroy', 1) }}"
                                                                     class="dropdown-item">
                                                                     Delete
                                                                 </a>
                                                                 <a href="{{ route('data-guards.edit', 1) }}"
                                                                     class="dropdown-item">
                                                                     Edit
                                                                 </a>
                                                                 <a href="{{ route('data-guards.show', 1) }}"
                                                                     class="dropdown-item">
                                                                     Show
                                                                 </a>
                                                             </div>
                                             ...
                                             <div class="card">
                                                 <div class="card-body">
                                                     ...
                                                     <div class="text-center mb-5">
                                                         ...
                                                         <h2 class="card-title">
                                                             <a class="item-name"
                                                                 href="{{ route('data-guards.show', 1) }}">Dianna
                                                                 Smiley</a>
                                                         </h2>
