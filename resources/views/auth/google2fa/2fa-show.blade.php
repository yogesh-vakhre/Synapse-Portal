                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        @if (empty($user->google2fa_secret))
                            <form class="form-horizontal" method="POST" action="{{ route('google2fa.generate_secret') }}">
                                {{ csrf_field() }}
                        ...
                        @elseif($user->google2fa_enable === 0)
                            ...
                            <form class="form-horizontal" method="POST" action="{{ route('google2fa.enable') }}">
                                {{ csrf_field() }}
                        ...
                        @elseif($user->google2fa_enable === 1)
                            ...
                            <form class="form-horizontal" method="POST" action="{{ route('google2fa.disable') }}">
